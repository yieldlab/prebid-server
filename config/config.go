...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.brightroll.usersync_url", "//east-bid.ybp.yahoo.com/sync/appnexuspbs?gdpr={{gdpr}}&euconsent={{gdpr_consent}}&url=")
	...
	v.SetDefault("adapters.eplanning.usersync_url", "//sync.e-planning.net/um?uid")
	...
	v.SetDefault("adapters.rubicon.usersync_url", "//pixel.rubiconproject.com/exchange/sync.php?p=prebid&gdpr={{gdpr}}&gdpr_consent={{gdpr_consent}}")
	...
	v.SetDefault("adapters.adkerneladn.usersync_url", "//tag.adkernel.com/syncr?gdpr={{gdpr}}&gdpr_consent={{gdpr_consent}}&r=")
